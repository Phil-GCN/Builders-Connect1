...
const Communications: React.FC = () => {
  ...
  const totalUnread = unreadNotifications + unreadMessages + roleRequests.length;
              ...
              <div className="bg-white rounded-xl border-2 border-blue-200 p-6">
                ...
                <div className="space-y-3">
                  {roleRequests.map(request => {
                    const isDemotion = request.to_role.name !== request.from_role.name;
                    return (
                      <div key={request.id} className="bg-blue-50 rounded-lg p-4">
                        <p className="text-sm text-gray-900 mb-2">
                          ...
                          {' '}wants to change your role from{' '}
                          <span style={{ color: request.from_role.color }} className="font-semibold">
